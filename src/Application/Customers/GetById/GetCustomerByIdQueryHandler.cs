	...
	public class GetCustomerByIdQueryHandler : IRequestHandler<GetCustomerByIdQuery, GetCustomerByIdQueryResponse?>
	{
        ...
        private GetCustomerByIdQueryResponse? MapToResponse(Customer customer)
        {
            if (customer is not null)
                return new GetCustomerByIdQueryResponse(customer.Identification, customer.FirstName, customer.LastName, customer.Email, customer.BirthDate, customer.Address, customer.City, customer.Country);
