...
namespace Application.Customers.GetAll
{
	public class GetAllCustomersQueryHandler : IRequestHandler<GetAllCustomersQuery, IEnumerable<GetAllCustomersQueryResponse>>
	{
        ...
        {
            return new GetAllCustomersQueryResponse(customer.Identification, customer.FirstName, customer.LastName, customer.Email, customer.BirthDate, customer.Address, customer.City, customer.Country);
        }
    }
}
